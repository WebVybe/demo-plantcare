...
export default function StickyQuote() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 flex gap-2 border-t border-black/10 bg-canvas/95 p-3 backdrop-blur-md shadow-[0_-8px_24px_-16px_rgba(0,0,0,0.3)] sm:hidden">
      <a
        href={plantco.phoneHref}
        aria-label={`Call ${plantco.name}`}
