...
// Three named, tiered maintenance plans shown side by side, replacing a
...
// single line of prose buried in copy, letting someone confirm in one
...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    detail: 'Started as a client before joining the team, and still owns the fiddle-leaf fig that got him hooked.',
    variant: 3,
  },
]
...
// Real, licensed stock photography (see photo credits in BeforeAfter.tsx),
// not a literal same-plants documented job -- each pair is a well-matched
// "struggling plant" / "thriving plant" illustrative substitute, labeled
// "Representative example" on the card so it doesn't read as a literal
// before/after of these exact plants. beforeVariant/afterVariant remain as
// the CSS-gradient fallback DecorPanel uses if an id has no photo pair.
